  ...
  ja: {
    translation: {
      app: {
        ...
        processing: '文字起こし中です。録音の長さと同程度の時間がかかります（長時間はさらにかかる場合があります）',
        processingTimer: '処理中... {{elapsed}}',
  ...
  en: {
    translation: {
      app: {
        ...
        processing: 'Transcribing. This may take as long as the recording itself (longer recordings may take more time).',
        processingTimer: 'Processing... {{elapsed}}',
      ...
      recorder: {
        ...
        duration: 'Recording time {{duration}}',
